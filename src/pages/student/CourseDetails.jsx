    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by:{" "}
            <span className="text-blue-600 underline">Milan Moktan</span>
          </p>
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  ...
                  >
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-b-gray-300">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className="flex items-center gap-1">
                ...
                <p>{calculteNoOfLecture(courseData)} lessons</p>
              </div>

            </div>

            <button className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white fotn-medium">{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll now'}</button>
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Certification to complete.</li>
              </ul>
            </div>
